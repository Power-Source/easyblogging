...
* Security: Nonce-Verifizierung zu POST-Handlern erweitert
* PHP 8: Error Suppression Operatoren (@) entfernt
* PHP 8: Deprecated Functions aktualisiert (update_usermeta → update_user_meta, stripslashes → wp_unslash)
* PHP 8: Property-Deklarationen zu modernen Visibility-Modifiern (var → private) aktualisiert
* Security: POST-Data Sanitization verstärkt
* Minimum PHP Version auf 7.4 erhöht (PHP 8 Kompatibilität erforderlich)
